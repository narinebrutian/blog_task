...
<head>
    ...
    <title>Publication - Blog Category Bootstrap Responsive Website Template - Home :: W3Layouts</title>
...
<header id="site-header">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark stroke p-0">
            <h1> <a class="navbar-brand" href="index.blade.php">
                    Publication
                </a></h1>
                ...
                <div class="real_info">
                        <div class="reallogin_info">
                            ...
                            <form action="{{ route('login') }}" method="post">
                                ...
                                <button class="btn btn-primary theme-button btn-login" type="submit" id="signUpBtn">Sign Up</button>
                            </form>
                            <p class="account">By clicking Signup, you agree to our <a href="#terms">Terms &amp; Conditions!</a></p>
                            <p class="account1">Already Registered? <a href="login.blade.php">Login here</a></p>
                        </div>
                    </div>
            </div>
        </div>
                ...
                <div class="real_info">
                    <div class="reallogin_info">
                        ...
                        <form action="../dashboard.blade.php" method="post">
                            ...
                            <button class="btn btn-primary theme-button btn-login" type="submit">Log in</button>
                        </form>
                        <p class="account1">Dont have an account? <a href="signUp.blade.php">Register here</a></p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="container">
                                <div class="banner-info-bg text-center">
                                    ...
                                    <ul class="author-date mb-4 d-flex align-items-center mt-4 justify-content-center">
                                        <li class="circle avatar"><img src="../../images/author1.jpg" alt=""></li>
                        ...
                        <div class="banner-info">
                            <div class="container">
                                <div class="banner-info-bg text-center">
                                    ...
                                    <ul class="author-date mb-4 d-flex align-items-center mt-4 justify-content-center">
                                        <li class="circle avatar"><img src="../../images/author2.jpg" alt=""></li>
                        ...
                        <div class="banner-info">
                            <div class="container">
                                <div class="banner-info-bg text-center">
                                    ...
                                    <ul class="author-date mb-4 d-flex align-items-center mt-4 justify-content-center">
                                        <li class="circle avatar"><img src="../../images/author3.jpg" alt=""></li>
        ...
        <div class="row no-gutters">
                ...
                <div class="blog-post d-flex flex-wrap align-content-between">
                    <div class="post-content">
                        <ul class="author-date mb-4 d-flex align-items-center">
                            <li class="circle-lg avatar"><img src="../../images/author4.jpg" alt=""></li>
            ...
            <a href="#blog-single.html" class="col-lg-6 blog-article-posts bg-color-two">
                <div class="blog-post d-flex flex-wrap align-content-between">
                    <div class="post-content">
                        <ul class="author-date mb-4 d-flex align-items-center">
                            <li class="circle-lg avatar"><img src="../../images/author5.jpg" alt=""></li>
            ...
            <a href="#blog-single.html" class="col-lg-6 blog-article-posts bg-color-three">
                <div class="blog-post d-flex flex-wrap align-content-between">
                    <div class="post-content">
                        <ul class="author-date mb-4 d-flex align-items-center">
                            <li class="circle-lg avatar"><img src="../../images/author6.jpg" alt=""></li>
            ...
            <a href="#blog-single.html" class="col-lg-6 blog-article-posts bg-color-four">
                <div class="blog-post d-flex flex-wrap align-content-between">
                    <div class="post-content">
                        <ul class="author-date mb-4 d-flex align-items-center">
                            <li class="circle-lg avatar"><img src="../../images/author7.jpg" alt=""></li>
...
<section class="w3l-index5">
    <div class="row abouthy-img-grids no-gutters">
        <div class="col-lg-6 img-one order-1">
            <a href="#blog-single.html"><img src="../../images/img2.jpg" alt=" " class="img-fluid"></a>
        </div>
        <a href="#blog-single.html" class="col-lg-6 order-2 blog-article-posts bg-color-one">
            <div class="blog-post d-flex flex-wrap align-content-between">
                <div class="post-content">
                    <ul class="author-date mb-4 d-flex align-items-center">
                        <li class="circle-lg avatar"><img src="../../images/author8.jpg" alt=""></li>
                        <li>by <b>Dhony Abraham</b></li>
                        <li><span class="fa fa-clock-o" aria-hidden="true"></span> Feb 16, 2020</li>
                    </ul>
        ...
        <a href="#blog-single.html" class="col-lg-6 order-lg-3 order-4 blog-article-posts bg-color-two">
            <div class="blog-post d-flex flex-wrap align-content-between">
                <div class="post-content">
                    <ul class="author-date mb-4 d-flex align-items-center">
                        <li class="circle-lg avatar"><img src="../../images/author9.jpg" alt=""></li>
                        <li>by <b>Rhoda Byrd</b></li>
        ...
        <div class="col-lg-6 img-one order-lg-4 order-3">
            <a href="#blog-single.html"><img src="../../images/img3.jpg" alt=" " class="img-fluid"></a>
        </div>
    </div>
</section>
<!-- /w3l-content-grids-->
        ...
        <div class="row align-items-center">
            <div class="col-lg-3 col-sm-4 col-7 order-first">
                <div class="author-image">
                    <img src="../../images/main-author.jpg" alt="" class="img-fluid">
                </div>
            </div>
        ...
        <div class="container py-lg-3">
            <div class="row">
                <div class="col-lg-6">
                    <div class="slider-info">
                        <div class="img-circle">
                            <a href="#author.html"><img src="../../images/author1.jpg" class="img-fluid" alt="author image"></a>
                        </div>
                        <div class="message">
                ...
                <div class="col-lg-6">
                    <div class="slider-info">
                        <div class="img-circle">
                            <a href="#author.html"><img src="../../images/author2.jpg" class="img-fluid" alt="author image"></a>
                        </div>
                        <div class="message">
                            <ul class="blog-single-author-date d-flex align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="slider-info">
                        <div class="img-circle">
                            <a href="#author.html"><img src="../../images/author3.jpg" class="img-fluid" alt="author image"></a>
                        </div>
                        <div class="message">
                            <ul class="blog-single-author-date d-flex align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="slider-info">
                        <div class="img-circle">
                            <a href="#author.html"><img src="../../images/author4.jpg" class="img-fluid" alt="author image"></a>
                        </div>
                        <div class="message">
                            <ul class="blog-single-author-date d-flex align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="slider-info">
                        <div class="img-circle">
                            <a href="#author.html"><img src="../../images/author5.jpg" class="img-fluid" alt="author image"></a>
                        </div>
                        <div class="message">
                            <ul class="blog-single-author-date d-flex align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="slider-info">
                        <div class="img-circle">
                            <a href="#author.html"><img src="../../images/author6.jpg" class="img-fluid" alt="author image"></a>
                        </div>
                        <div class="message">
                            <ul class="blog-single-author-date d-flex align-items-center">
